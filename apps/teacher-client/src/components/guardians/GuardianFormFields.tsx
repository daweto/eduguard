        ...
        <form.Field name={getFieldName("firstName")}>
          ...
          {(field: any) => {
            ...
            const showError = formFieldErrorVisible(
              typedField.state.meta.isTouched,
              typedField.state.meta.errors.length > 0,
            );
            return (
              <Field data-invalid={showError} className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("firstName.label"))} *
                </FieldLabel>
                <FieldContent>
                  <Input
                    id={typedField.name}
        ...
        <form.Field name={getFieldName("lastName")}>
          ...
          {(field: any) => {
            ...
            return (
              <Field data-invalid={showError} className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("lastName.label"))} *
                </FieldLabel>
                <FieldContent>
                  <Input
                    id={typedField.name}
          ...
          {(field: any) => {
            ...
            return (
              <Field className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("middleName.label"))}
                </FieldLabel>
                <FieldContent>
                  <Input
                    id={typedField.name}
        ...
        <form.Field name={getFieldName("secondLastName")}>
          ...
          {(field: any) => {
            ...
            return (
              <Field className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("secondLastName.label"))}
                </FieldLabel>
                <FieldContent>
                  <Input
                    id={typedField.name}
                    ...
                    onBlur={typedField.handleBlur}
                    placeholder={t(
                      getTranslationKey("secondLastName.placeholder"),
                    )}
                  />
                </FieldContent>
              </Field>
        ...
        <form.Field name={getFieldName("identificationNumber")}>
          ...
          {(field: any) => {
            ...
            return (
              <Field data-invalid={showError} className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("identification.label"))} *
                </FieldLabel>
                <FieldContent>
                  <Input
                    id={typedField.name}
                    ...
                    onBlur={() => {
                      ...
                      form.setFieldValue(
                        typedField.name,
                        formatRut(typedField.state.value),
                      );
                    }}
                    placeholder={t(
                      getTranslationKey("identification.placeholder"),
                    )}
                    aria-invalid={showError}
                    inputMode="text"
        ...
        <form.Field name={getFieldName("phone")}>
          ...
          {(field: any) => {
            ...
            return (
              <Field data-invalid={showError} className="space-y-2">
                <FieldLabel htmlFor={typedField.name}>
                  {t(getTranslationKey("phone.label"))} *
                </FieldLabel>
                <FieldContent>
                  <PhoneInput
                    value={typedField.state.value}
                    ...
                    placeholder={
                      t(getTranslationKey("phone.placeholder")) as string
                    }
                    defaultCountry="CL"
                  />
                </FieldContent>
      ...
      <form.Field name={getFieldName("email")}>
        ...
        {(field: any) => {
          ...
          return (
            <Field data-invalid={showError} className="space-y-2">
              <FieldLabel htmlFor={typedField.name}>
                {t(getTranslationKey("email.label"))} *
              </FieldLabel>
              <FieldContent>
                <Input
                  id={typedField.name}
