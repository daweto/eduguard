...
export default function GuardiansHomePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">{t('guardians:page.title')}</h1>
        ...
        <Card>
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link to="/guardians/list">{t('guardians:cards.list.action')}</Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Button asChild variant="outline" className="w-full">
              <Link to="/guardians/create">{t('guardians:cards.create.action')}</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
